...
| 📅 **[RunPlan](https://github.com/XandyGomes/runplan)** | Planos de corrida periodizados (base → pico → polimento) conectados ao Strava, com progressão de volume automática e resumo de treino gerado por IA. | `Next.js` `TypeScript` `Supabase` `Strava API` | [Demo](https://runplan-beige.vercel.app) |
