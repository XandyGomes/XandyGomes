...
<p align="center">
  <img src="https://img.shields.io/badge/FATEC-Professor-blueviolet?style=for-the-badge" />
  <img src="https://img.shields.io/badge/UNIFACEF-Professor-blueviolet?style=for-the-badge" />
  <img src="https://img.shields.io/badge/SENAI-Professor-blueviolet?style=for-the-badge" />
  <img src="https://img.shields.io/badge/USP-Mestre_%26_Pesquisador-003087?style=for-the-badge" />
</p>
...
| 📅 **[RunPlan](https://github.com/XandyGomes/runplan)** | Planos de corrida periodizados (base → pico → polimento) conectados ao Strava. Motor determinístico garante progressão de volume segura (validada contra os planos do Hal Higdon); a IA revisa o plano como um treinador, incorporando contexto do atleta. Inclui treino de força com exercícios ilustrados. | `Next.js` `TypeScript` `Supabase` `Groq/Gemini` `Strava API` | [Demo](https://runplan-beige.vercel.app) |
...
| 🌅 **[BomDia Share](https://github.com/XandyGomes/bomdia-share)** | App mobile de mensagens de bom dia/motivação pro WhatsApp: busca combinando 3 fontes de imagem com fallback automático entre elas, histórico local anti-repetição e frases geradas por IA (Gemini) compostas sobre a foto em tempo real. | `React Native` `Expo` `Gemini AI` | [APK](https://expo.dev/accounts/xandygomes/projects/bomdia-share/builds/7f8dfc41-adf7-4a80-9e78-b0c12a5639c0) |
...
|---|---|---|
| 🧮 **[Estrutura de Dados](https://github.com/XandyGomes/ed)** | Site interativo com os 20 tópicos da disciplina (arrays, ordenação, recursividade, listas, árvores, hash, grafos), cada um com lição, animação passo a passo do algoritmo e quiz. Unifica o material usado nas turmas de FATEC, Uni-FACEF, SENAI e Anhanguera | [Acessar](https://xandygomes.github.io/ed/) |
