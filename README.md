...
| 📅 **[RunPlan](https://github.com/XandyGomes/runplan)** | Planos de corrida periodizados (base → pico → polimento) conectados ao Strava. Motor determinístico garante progressão segura (regra dos 8%/semana); a IA revisa o plano inteiro como um treinador, incorporando contexto do atleta (lesões, restrições). | `Next.js` `TypeScript` `Supabase` `Groq/Gemini` `Strava API` | [Demo](https://runplan-beige.vercel.app) |
